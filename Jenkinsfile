pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
            	discordSend description: "Adrian", footer: "Pipeline start", link: env.BUILD_URL, result: currentBuild.currentResult, title: "ADRIAN", webhookURL: "https://discord.com/api/webhooks/1403692153439391754/jQaX79xZrL0QqQ4PlwgmUwclwU4Fpriv1yxOowDFKiFPI8wmjoVsjeULtlC7QKFknd9a"
    ...
    post {
		failure {
			discordSend description: "Something failed", footer: "Oh no!", link: env.BUILD_URL, result: currentBuild.currentResult, title: env.JOB_NAME, webhookURL: "https://discord.com/api/webhooks/1403692153439391754/jQaX79xZrL0QqQ4PlwgmUwclwU4Fpriv1yxOowDFKiFPI8wmjoVsjeULtlC7QKFknd9a"
		}
		}
}